...
```
qodo whoami --json --skill qodo-review --skill-version 1.9.2 --distribution kiro-power --host kiro
...
wait "${qodo_review_pid}"; status=$?                                         # capture exit — but do NOT abort on non-zero
