...
```sh
<qodo> read whoami --json --skill qodo-setup --skill-version 1.0.7 --distribution kiro-power --host kiro
```
...
```sh
<qodo> tools --refresh --json --skill qodo-setup --skill-version 1.0.7 --distribution kiro-power --host kiro
```
