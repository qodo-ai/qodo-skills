...
```sh
qodo help workflow qodo-manage-standards --distribution kiro-power --host kiro --json
```
...
within workflow `qodo-manage-standards`, package `qodo-standards`, lifecycle `kiro-power`, and host
