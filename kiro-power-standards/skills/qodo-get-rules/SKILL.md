...
```sh
qodo help workflow qodo-get-rules --distribution kiro-power --host kiro --json
```
...
within workflow `qodo-get-rules`, package `qodo-standards`, lifecycle `kiro-power`, and host
