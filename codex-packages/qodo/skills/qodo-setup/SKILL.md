...
Run `<qodo> read whoami --json --skill qodo-setup --skill-version 1.0.6 --distribution marketplace --host codex`.
...
```sh
<qodo> read whoami --json --skill qodo-setup --skill-version 1.0.6 --distribution marketplace --host codex
<qodo> tools --refresh --json --skill qodo-setup --skill-version 1.0.6 --distribution marketplace --host codex
```
