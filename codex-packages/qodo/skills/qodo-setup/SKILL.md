...
Run `<qodo> whoami --json --skill qodo-setup --skill-version 1.0.4 --distribution marketplace --host codex`.
...
```sh
<qodo> whoami --json --skill qodo-setup --skill-version 1.0.4 --distribution marketplace --host codex
