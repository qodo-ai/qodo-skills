...
```sh
<qodo> read whoami --json --skill qodo-setup --skill-version 1.0.9 --distribution marketplace --host codex
```
...
```sh
<qodo> tools --refresh --json --skill qodo-setup --skill-version 1.0.9 --distribution marketplace --host codex
```
