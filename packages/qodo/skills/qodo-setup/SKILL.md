...
```sh
qodo --version --skill qodo-setup --skill-version 1.0.2 --distribution marketplace
```

If the shell reports `qodo: command not found`, retry the standard user-scoped location:

```sh
"${QODO_HOME:-$HOME/.qodo}/bin/qodo" --version --skill qodo-setup --skill-version 1.0.2 --distribution marketplace
```
...
Run `<qodo> whoami --json --skill qodo-setup --skill-version 1.0.2 --distribution marketplace`.
...
```sh
<qodo> whoami --json --skill qodo-setup --skill-version 1.0.2 --distribution marketplace
<qodo> tools --refresh --json --skill qodo-setup --skill-version 1.0.2 --distribution marketplace
```
