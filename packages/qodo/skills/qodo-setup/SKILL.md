...
```sh
<qodo> read whoami --json --skill qodo-setup --skill-version 1.0.9 --distribution marketplace --host claude-code
```
...
```sh
<qodo> tools --refresh --json --skill qodo-setup --skill-version 1.0.9 --distribution marketplace --host claude-code
```
