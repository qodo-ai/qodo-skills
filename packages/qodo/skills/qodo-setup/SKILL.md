...
Run `<qodo> read whoami --json --skill qodo-setup --skill-version 1.0.6 --distribution marketplace --host claude-code`.
...
```sh
<qodo> read whoami --json --skill qodo-setup --skill-version 1.0.6 --distribution marketplace --host claude-code
<qodo> tools --refresh --json --skill qodo-setup --skill-version 1.0.6 --distribution marketplace --host claude-code
```
