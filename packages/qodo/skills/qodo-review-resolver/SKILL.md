...
```sh
qodo help workflow qodo-review-resolver --distribution marketplace --host claude-code --json
```
...
within workflow `qodo-review-resolver`, package `qodo`, lifecycle `marketplace`, and host
