...
- ⏳ **Issue Title** (Severity) - Deferred - brief reason
...
Emoji per closed reason: ⏳ `deferred` · 🔍 `false_positive` · 🎯 `intentional` · 🚫 `rejected` (won't fix). List only the rows that apply.
