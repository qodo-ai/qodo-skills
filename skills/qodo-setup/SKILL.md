...
```sh
<qodo> read whoami --json --skill qodo-setup --skill-version 1.0.8 --distribution skills-sh
```
...
```sh
<qodo> tools --refresh --json --skill qodo-setup --skill-version 1.0.8 --distribution skills-sh
```
