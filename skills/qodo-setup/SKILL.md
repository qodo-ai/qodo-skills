...
Run `<qodo> whoami --json --skill qodo-setup --skill-version 1.0.4 --distribution skills-sh`.
...
```sh
<qodo> whoami --json --skill qodo-setup --skill-version 1.0.4 --distribution skills-sh
